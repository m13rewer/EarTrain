...
export class LearnerComponent implements OnInit {
  ...
  @ViewChild("topThree") private el: ElementRef;
  ...
  ngOnInit() {
    ...
    //console.log(this.StatStore);
    //this.assessment = [[],[],[]];
    //this.IntervalMap = new IntervalMap();
    // let test1Note = new Note();
    // test1Note.pitch = "c#";
    // test1Note.octave = 2;
    // let test2Note = new Note();
    // test2Note.pitch = "e";
    // test2Note.octave = 4;
    // this.keyArray = ['a', 'b', 'c#', 'd', 'e', 'f#', 'g#'];
    // this.calculateIntervalAsc(test1Note, test2Note);
    // this.calculateIntervalDesc(test2Note, test1Note);
    //this.setStatStore(this.calculateIntervalAsc(test1Note, test2Note));
    //this.setStatStoreMap();
  }
